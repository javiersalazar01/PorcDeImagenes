...
import com.untref.modelo.MatrizDeColores;
import com.untref.utiles.FiltroGaussiano;
import com.untref.utiles.FiltroNuevo;
...
public class DetectorDeBordesDeCanny {
    ...
    public static Imagen mostrarUmbralizacionConHisteresis(Imagen imagenOriginal, int umbral1, int umbral2) {
        MatrizDeColores matrices = calcularSupresionNoMaximos(imagenOriginal);
        ...
        int[][] matrizAFinal =  TransponerMatriz(matrizA);
        
      
        
        Imagen imagenResultante = new Imagen(MatricesManager.obtenerImagenDeMatrices(matrizRFinal, matrizVFinal, matrizAFinal), imagenOriginal.getFormato(), imagenOriginal.getNombre() + "_umbralHisteresis");
    ...
    public static int[][] TransponerMatriz(int[][] matriz) {
        ...
        for (int x = 0; x < matriz.length; x++) {
            for (int y = 0; y < matriz[x].length; y++) {
                matrizResultante[y][x] = matriz[x][y];
            }
        }
        return matrizResultante;
    }
...
public static MatrizDeColores calcularMatrizConFiltrosGauss(Imagen imagenOriginal, int sigma) {
    ...
    public static Imagen aplicarDetectorDeCanny(Imagen imagenActual, int sigma1, int sigma2, int umbral1, int umbral2) {
        ...
        int[][] matrizAT = TransponerMatriz(matrizAzulFinal);
        
        
        BufferedImage bufferedNuevo = MatricesManager.obtenerImagenDeMatrices(matrizRT, matrizVT, matrizAT);
